...
function Image({ image, className }: ProductImageProps) {
  return (
    <img
      src={image}
      alt="Product"
      className={cn("aspect-video h-20 object-cover rounded-md", className)}
    />
  );
}
...
function Description({ children, className }: DescriptionProps) {
  return (
    <span className={cn("text-secondary text-sm text-wrap", className)}>
      {children}
    </span>
  );
}
...
function ProductInfo({ children, className }: ProductInfoProps) {
  return (
    <div className={cn("flex flex-1 flex-col gap-3 w-full", className)}>
      {children}
    </div>
  );
}
...
function Name({ children, className }: NameProps) {
  return (
    <h3 className={cn("text-primary text-sm font-semibold", className)}>
      {children}
    </h3>
  );
}
...
function DiscountedPrice({ children, className }: DiscountedPriceProps) {
  return (
    <span className={cn("text-text-tertiary text-xs line-through", className)}>
      {children}
    </span>
  );
}
